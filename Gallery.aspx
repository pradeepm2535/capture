...
<li><a data-isotope-filter="*" data-isotope-group="gallery" href="#" class="active">show all</a></li>
...
<div class="col-lg-12">
<div data-photo-swipe-gallery="gallery" data-isotope-layout="fitRows" data-isotope-group="gallery" class="isotope">
<div class="row">
<div data-filter="*" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-01.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-01.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 3" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-02.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-02.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 3" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-03.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-03.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 3" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-04.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-04.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 2" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-05.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-05.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 2" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-06.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-06.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-07.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-07.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-08.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-08.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-09.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-09.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-10.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-10.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-11.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-11.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
<div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item"><a data-photo-swipe-item="" data-size="390x390" href="images/gallery-12.jpg" data-author="Michael Hull" class="thumbnail-custom"><img width="390" height="390" src="images/gallery-12.jpg" alt="" class="img-responsive">
<div class="caption">
<div class="fa-search-plus"></div>
</div></a></div>
</div>
...
Glasgow D04 89GR
                            <br>
                            Email: <a class="p" href="/cdn-cgi/l/email-protection#cae9"><span class="__cf_email__" data-cfemail="80e9eee6efc0e4e5edefece9eeebaeeff2e7">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function (t, e, r, n, c, a, p) { try { t = document.currentScript || function () { for (t = document.getElementsByTagName('script'), e = t.length; e--;) if (t[e].getAttribute('data-cfhash')) return t[e] }(); if (t && (c = t.previousSibling)) { p = t.parentNode; if (a = c.getAttribute('data-cfemail')) { for (e = '', r = '0x' + a.substr(0, 2) | 0, n = 2; a.length - n; n += 2) e += '%' + ('0' + ('0x' + a.substr(n, 2) ^ r).toString(16)).slice(-2); p.replaceChild(document.createTextNode(decodeURIComponent(e)), c) } p.removeChild(t) } } catch (u) { } }()/* ]]> */</script></a>
                        </p>
                    </div>
                    <div class="cell-md-5">
